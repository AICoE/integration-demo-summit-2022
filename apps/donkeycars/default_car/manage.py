...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type="single", meta=[]):
    ...
    if camera_type == "stereo":
        ...
        if cfg.DONKEY_GYM:
            ...
            cam = V4LCamera(
                image_w=cfg.IMAGE_W, image_h=cfg.IMAGE_H, image_d=cfg.IMAGE_DEPTH, framerate=cfg.CAMERA_FRAMERATE
            )
    ...
    if cfg.HAVE_IMU:
        ...
        V.add(
            imu, outputs=["imu/acl_x", "imu/acl_y", "imu/acl_z", "imu/gyr_x", "imu/gyr_y", "imu/gyr_z"], threaded=True
        )
    ...
    # IMU
        ...
        inputs = ["cam/image_array", "imu/acl_x", "imu/acl_y", "imu/acl_z", "imu/gyr_x", "imu/gyr_y", "imu/gyr_z"]
    elif cfg.USE_LIDAR:
        inputs = ["cam/image_array", "lidar/dist_array"]
    else:
        inputs = ["cam/image_array"]
    ...
    if cfg.STOP_SIGN_DETECTOR:
        ...
        V.add(
            StopSignDetector(cfg.STOP_SIGN_MIN_SCORE, cfg.STOP_SIGN_SHOW_BOUNDING_BOX),
    ...
    if cfg.DONKEY_GYM or cfg.DRIVE_TRAIN_TYPE == "MOCK":
        ...
        V.add(two_wheel_control, inputs=["throttle", "angle"], outputs=["left_motor_speed", "right_motor_speed"])
        ...
        left_motor = L298N_HBridge_DC_Motor(
            cfg.HBRIDGE_L298N_PIN_LEFT_FWD, cfg.HBRIDGE_L298N_PIN_LEFT_BWD, cfg.HBRIDGE_L298N_PIN_LEFT_EN
        )
        right_motor = L298N_HBridge_DC_Motor(
            cfg.HBRIDGE_L298N_PIN_RIGHT_FWD, cfg.HBRIDGE_L298N_PIN_RIGHT_BWD, cfg.HBRIDGE_L298N_PIN_RIGHT_EN
        )
        two_wheel_control = TwoWheelSteeringThrottle()
        ...
        steering_controller = PiGPIO_PWM(
            cfg.STEERING_PWM_PIN, freq=cfg.STEERING_PWM_FREQ, inverted=cfg.STEERING_PWM_INVERTED
        )
        steering = PWMSteering(
            controller=steering_controller, left_pulse=cfg.STEERING_LEFT_PWM, right_pulse=cfg.STEERING_RIGHT_PWM
        )
        ...
        throttle_controller = PiGPIO_PWM(
            cfg.THROTTLE_PWM_PIN, freq=cfg.THROTTLE_PWM_FREQ, inverted=cfg.THROTTLE_PWM_INVERTED
        )
        throttle = PWMThrottle(
            controller=throttle_controller,
            max_pulse=cfg.THROTTLE_FORWARD_PWM,
    ...
    if cfg.HAVE_IMU or (cfg.CAMERA_TYPE == "D435" and cfg.REALSENSE_D435_IMU):
        inputs += ["imu/acl_x", "imu/acl_y", "imu/acl_z", "imu/gyr_x", "imu/gyr_y", "imu/gyr_z"]
